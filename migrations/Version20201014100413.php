 ...
 */
final class Version20201014100413 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD type_id INT NOT NULL, DROP type, CHANGE photo photo VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD type VARCHAR(100) NOT NULL COLLATE utf8_unicode_ci, DROP type_id, CHANGE photo photo VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci');
